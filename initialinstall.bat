...
set "programs=jetbrainstoolbox vscode dbeaver github-desktop notion git nvm docker-desktop bitwarden authy googlechrome brave postman insomnia-rest-api-client winrar discord"
